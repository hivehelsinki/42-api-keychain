...
const Navbar: FC<navbarProps> = ({ user }) => {
  return (
    <nav className="supports-backdrop-blur:bg-background/60 sticky top-0 z-10  flex h-16 w-full border-b bg-background/95 text-gray-950 backdrop-blur dark:border-b-gray-600 dark:bg-gray-900 dark:text-gray-100">
